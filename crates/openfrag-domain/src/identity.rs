...
impl CalculationIdentity {
    pub fn ofr_v1(
        ...
        parser_commit: impl Into<String>,
        parser_build: impl Into<String>,
        generated_proto_build: impl Into<String>,
        requested_schema_hash: impl Into<String>,
        ...
        Self {
            ...
            requested_schema_hash: requested_schema_hash.into(),
    ...
    pub fn requested_schema_hash(&self) -> &str {
        &self.requested_schema_hash
    }
...
impl CalculationSeriesIdentity {
    ...
    pub fn is_parser_only_rebind_to(&self, other: &Self) -> bool {
        self.local_player_id == other.local_player_id
            && self.generated_proto_build == other.generated_proto_build
            && self.requested_schema_hash == other.requested_schema_hash
            ...
            && (self.parser_commit != other.parser_commit
                || self.parser_build != other.parser_build)
    }
}
